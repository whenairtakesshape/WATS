...
function Map() {
  ...
  const searchFiltered: Array<Datapoint> = searchInfo.term == "" ? data.priority_data
    : data.all_data.filter((datapoint) =>
      datapoint.cityCountry.toLocaleLowerCase().includes(searchInfo.term.toLocaleLowerCase()));
